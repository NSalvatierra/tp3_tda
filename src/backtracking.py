...
def backtracking_recursivo(
        vertice_actual, vertices, k_clusters, distancias, clusters, diametros_clusters, mejor_solucion
):
    ...
    return mejor_solucion  # Corregido: siempre devuelve algo
...
def backtracking(grafo: Grafo, k_clusters):
    ...
    return backtracking_recursivo(
        0, vertices, k_clusters, distancias, clusters, diametros_clusters, mejor_solucion
    )
